...
**Confidence:** MEDIUM (websearch-only research — all findings from public web sources, no HIGH-confidence curated/vendor-docs cross-check was performed; version numbers verified against npm/vendor pages, but iOS Safari behavioral claims should be spot-checked on an actual iPhone before locking in the roadmap)
...
**If storage/perf becomes a bottleneck after shipping v1 with Dexie:**
...
**If you need push notifications or true background sync later:**
...
---
*Stack research for: client-only installable iOS audiobook PWA*
*Researched: 2026-08-07*
